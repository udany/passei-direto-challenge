...
/**
 * @name Entity
 * @static {Entity.Attributes.Object[]} Attributes
 * @extends Emitter
 */
...
Entity.prototype.proxyArrayEvents = function (array, attr) {
    ...
    array.onAny((e, ...args) => { this.emit('list-change', [e, attr, ...args]); }, uid);

    array.on('add', (...args) => { this.emit('list-add', [attr, ...args]); }, uid);

    array.on('remove', (...args) => { this.emit('list-remove', [attr, ...args]); }, uid);
};
...
/// == Object
Entity.Attributes.Object = class {
    constructor(name) {
        this.name = name;
...
/// == Formatted String
Entity.Attributes.FormattedString = class extends Entity.Attributes.String {
    format(val) {
...
/// == Integer
Entity.Attributes.Integer = class extends Entity.Attributes.Object {
    constructor(name, nullable, def = 0) {
        super(name);
...
/// == Float
Entity.Attributes.Float = class extends Entity.Attributes.Integer {
    Get(obj) {
...
/// == Boolean
Entity.Attributes.Boolean = class extends Entity.Attributes.Integer {
    Get(obj) {
...
/// == Integer
Entity.Attributes.Json = class extends Entity.Attributes.Object {
    Get(obj) {
...
/// == Array
Entity.Attributes.Array = class extends Entity.Attributes.Object {
    /**
     * @param obj
     * @returns {Array}
     */
...
/// == Entity
Entity.Attributes.Entity = class extends Entity.Attributes.Object {
    constructor(name, defaultEntity, encodeAsJson) {
        super(name);
        this.defaultEntity = defaultEntity;
        this.encodeAsJson = !!encodeAsJson;
        this._referential = false;
        this._default = null;
    }
     ...
     */
    Get(obj, safeOnly) {
        let a = obj[this.name] ? obj[this.name].Serialize(!!safeOnly) : this._default;
    ...
    Set(obj, val) {
        ...
        if (!val) dataArray = this._default;
    ...
    equals(a, b) {
        if (!a[this.name] || !a[this.name]) return a[this.name] === b[this.name];
...
/// == EntityList
Entity.Attributes.EntityList = class extends Entity.Attributes.Entity {
    Get(obj, safeOnly) {
        let a = obj[this.name];
...
/// == Date
Entity.Attributes.Date = class extends Entity.Attributes.Object {
...
/// == Custom
Entity.Attributes.Custom = class extends Entity.Attributes.Object {
